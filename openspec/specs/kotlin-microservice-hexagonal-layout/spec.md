# kotlin-microservice-hexagonal-layout Specification

## Purpose
TBD - created by archiving change add-hexagonal-sample-use-case-per-profile. Update Purpose after archive.
## Requirements
